			...
			<div class="col-lg-6 ">
				<div class="login-form border p-5 ">
					<div class="text-center heading ">
						...
						<p class="lead ">We have send OTP in the alert box.</p>
					</div>

					<form name="RegForm" method="post" action="client_fpassword_change.php" onsubmit="return GEEKFORGEEKS()">
						<div class="form-group mb-4 ">
							<label for="# ">Enter OTP</label>
							<input type="text" name="otp" required class="form-control " placeholder="">
            </div>
            <input type="submit" class="btn btn-main mt-3 btn-block" name="client_otp" value="SUBMIT">
					</form>
				</div>
			</div>
		</div>
