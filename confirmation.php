...
<!-- Mirrored from demo.themefisher.com/adrian/confirmation.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Feb 2020 18:33:55 GMT -->
...
<section class="page-wrapper success-msg ">
  <div class="container ">
    <div class="row ">
      <div class="col-lg-12 ">
          <h2 class="mb-5 ">Thank you! For your purchase.</h2>
          <h4 class="mb-5 ">Your Order is successfully placed.</h4>


          <a href="client_show_product.php " class="btn btn-main mt-4 ">Continue Shopping</a>
      </div>
    </div>
  </div>
