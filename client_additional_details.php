		...
		<div class="row justify-content-center ">
			<div class="col-lg-8 ">
				<div class="content text-center ">
					<h1 class="mb-2 ">ORDER Shipping Details</h1>
				</div>
			</div>
		</div>
	</div>
         ...
         <div class="row ">
            <div class="col-lg-8 pr-2 ">
               ...
               <div class="billing-details mt-5 ">
                  ...
                  <form class="checkout-form" name="frmUser" method="post" action="client_order_process.php" enctype="multipart/form-data" onsubmit="return GEEKFORGEEKS()">
                     <div class="row ">
                        ...
                        <div class="col-lg-12 ">
                            <div class="form-group mb-4 ">
                              ...
                              <textarea class="form-control " name = "address" id="address " required><?php echo $row['add1'];?></textarea>
                         ...
                         <div class="col-lg-12 ">
                            <div class="form-group mb-4 ">
                              ...
                              <input type="text " name="mobile" value="<?php echo $row['mobile'];?>" class="form-control" id="phone" required minlength="10" maxlength="10" placeholder="Enter mobile number without +91" required onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">
                           </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group mb-4">
                              <label for="form-control">PAYMENT MODE:</label>
                               <select class="form-control" name="pay_mode">
                               <option value="CASH_ON_DELIVERY">CASH ON DELIVERY</option>
                              </select>
                           </div>
                           <input type="submit" name="oreder_confirm" value="PLACE ORDER"  class="btn btn-main btn-small ">
                        </div>
                     </div>
...
<!-- Mirrored from demo.themefisher.com/adrian/checkout.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Feb 2020 18:33:55 GMT -->
</html>
<?php
}
else
{
  echo "<script>alert('EMPTY CART PLEASE BUY SOME PRODUCTS')
  window.location.href='client_show_product.php';</script>";
}
}
else
{

  echo "<script>alert('PLEASE LOGIN TO PROCEED ORDER')
