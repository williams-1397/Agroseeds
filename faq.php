...
<!-- Mirrored from demo.themefisher.com/adrian/faq.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Feb 2020 18:33:22 GMT -->
...
<section class="page-wrapper faq ">
	<div class="container ">
		<div class="row ">
			<div class="col-lg-6 ">
				<h4>How can I check Order Status?</h4>
				<p>Just login with your email and password. From the right upper corner just hover your cursor on person icon. Click on my order button, there will be all the details releted to your orders.</p>

				<h4>Shipping & Delivery</h4>
        <p>For shipping and delivery releted information you can check in my order page.</p>

				<h4>Payments</h4>
				<p>All the payments done at cash on delivery.</p>
			</div>
			<div class="col-lg-6 ">

				<h4>Returns & Exchanges</h4>
				<p>Return and exchange depends on the moment, Meanwhile you can ask on our helpline number. </p>

				<h4>Privacy Policy</h4>
				<p>We keep your information very safe and for better service only.</p>

				<h4>Refund Policy</h4>
				<p>Refund depends on situations.</p>
			</div>
		</div>
	</div>
</section>
