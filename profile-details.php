...
$result = mysqli_query($conn,"SELECT * FROM user WHERE email='" . $_SESSION['login_user'] . "'");
$row= mysqli_fetch_array($result);
?>
<!doctype html>
<html lang="en">

<!-- Mirrored from demo.themefisher.com/adrian/profile-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Feb 2020 18:33:57 GMT -->
 ...
 <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  ...
  <script>
        function GEEKFORGEEKS()
        {
            ...
            var cpassword =  document.forms["RegForm1"]["cpassword"];
            var passcheck =  document.forms["RegForm1"]["passcheck"];
            var oldpass =  document.forms["RegForm1"]["old_pass"];
            if (cpassword.value != password.value)
            {
                window.alert("NEW PASSWORD IS NOT MATCHING WITH CONFIRM NEW PASSWORD");
                password.focus();
                return false;
            }
            if(password.value.length < 6)
            {
                window.alert("password should be atlest 6 characters long");
                password.focus();
                return false;
            }
            if (oldpass.value != passcheck.value)
            {
            ...
            <div class="acccount-settings ">
              ...
              <form name="frmUser" method="post" action="process.php" enctype="multipart/form-data">
                <div class="form-row ">
                  <div class="col-lg-6 ">
                    ...
                    <input type="hidden" name="id" class="txtField" value="<?php echo $row['id']; ?>">
                      ...
                      <input type="text" name="f_name" required value="<?php echo $row['f_name'];?>"class="form-control " >
                    </div>
                  </div>
                  <div class="col-lg-6 ">
                    <div class="form-group ">
                      <label >Last Name</label>
                      <input type="text " name="l_name" required value="<?php echo $row['l_name'];?>"class="form-control " >
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group mb-4 ">
                  ...
                  <input type="text " name="d_name" value="<?php echo $row['d_name'];?>" class="form-control">
                ...
                <div class="form-group mb-4 ">
                  <label >Mobile </label>
                  <input type="text" name="mobile" minlength="10" maxlength="10" required value="<?php echo $row['mobile'];?>" class="form-control" >
                </div>
                <div class="form-group mb-4 ">
							<label>Address</label>
							<textarea class="form-control " name="add1" id="address "><?php echo $row['add1'];?></textarea>
						</div>
                <input class="btn btn-dark" type="submit" name="update_details" value="UPDATE">
              </form>

              <form name="RegForm1" method="post" action="process.php" onsubmit="return GEEKFORGEEKS()" class="mt-5 ">
                <h4>Password change</h4>
                <input type="hidden" name="id" class="txtField" value="<?php echo $row['id']; ?>">
                <input type="hidden" name="passcheck" class="txtField" value="<?php echo $row['password']; ?>">
                <div class="form-group ">
                  <label >Current password </label>
                  <input type="password" name="old_pass" required class="form-control " placeholder=" ">
                ...
                <input class="btn btn-dark" type="submit" name="update_password" value="UPDATE">
              </form>
            </div>
