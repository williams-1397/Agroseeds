		...
		<div class="row ">
					...
					<div class="col-lg-6 mb-5 mb-lg-0 ">
                      ...
                      India.</span>
							...
							<li>
								...
								<span>+91 (0286) 224 5725</span>
							</li>
							<li>
								<i class="tf-ion-android-mail mr-3 "></i>
								<span>agroseeds001@email.com</span>
							</li>
						</ul>
					</div>
			...
			<div class="contact-form col-lg-6 " >
				...
				<form id="contact-form " method="post" action="process.php" >
					...
					<div class="mt-4 ">
						<input type="submit" name ="contact" id="contact-submit " class="btn btn-black btn-small " value="Send Message ">
					</div>
				</form>
			</div>
			<!-- ./End Contact Form -->
