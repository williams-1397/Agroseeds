...
<!-- Mirrored from demo.themefisher.com/adrian/signup.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Feb 2020 18:33:57 GMT -->
<head>
<meta charset="utf-8">
         <!-- Required meta tags -->
  ...
  <script>
        function GEEKFORGEEKS()
        {
            ...
            {
                window.alert("Confirm password does not matched with password.");
                password.focus();
                return false;
            }
...
<div class="account section">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-6">
				<div class="login-form border p-5">
					<div class="text-center heading">
						...
						<p class="lead">Already have an account? <a href="login.php"> Login now</a></p>
					</div>
            ...
            <div class="form-group mb-4">
							<input type="text" name="d_name" class="form-control" placeholder="Username" required>
            </div>
            <div class="form-group mb-4">
						...
						<input type="submit" name="user_register" value="SUBMIT" class="btn btn-main mt-3 btn-block">
					</form>
				</div>
			</div>
		</div>
