...
<!-- Mirrored from demo.themefisher.com/adrian/client_show_product.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Feb 2020 18:33:22 GMT -->
<head>
 <!-- Required meta tags -->
...
<section class="page-header ">
	...
	<div class="container ">
		<div class="row justify-content-center ">
          ...
          <h1 class="mb-3 ">
            <?php if($_GET['catagory']=="CAREALS_AND_PULSES")
          {
            echo "CAREALS AND PULSES";
          }
          if($_GET['catagory']=="FIBRE_AND_OIL_CROPS")
          {
            echo "FIBRE AND OIL CROPS";
          }
          if($_GET['catagory']=="VEGITABLE_CROPS")
          {
            echo "VEGITABLE CROPS";
          }?> </h1>
				</div>
			</div>
		</div>
...
<section class="products-shop section">
  ...
  <div class="row justify-content-center ">
        ...
        $query = "SELECT * FROM product WHERE (catagory = '$cat')";
...
<!-- Mirrored from demo.themefisher.com/adrian/client_show_product.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Feb 2020 18:33:27 GMT -->
</html>
