		...
		<div class="row justify-content-center ">
			<div class="col-lg-6 ">
				<div class="content text-center ">
					<h1 class="mb-3 ">Quality Assurance</h1>
...
<section class="about section ">
	<div class="container ">
		<div class="row ">
          ...
          <img src="images/production/q1.jpg">
...
We are strictly adhered to maintain the Indian Minimum Seed Certification Standards and also ISTA norms.

Once the samples goes through stringent testing activities and qualifies in all the parameters then only released for the marketing.

A well established Seed Testing Laboratory with ultra-modern equipments with all facilities, trained and dedicated manpower are the strength of the Quality Assurance Department of Ajeet Seeds Private Limited.

To maintain the sanctity of seed quality, obviously Quality Assurance Department is working round the clock with due emphasis on Physical Purity, Seed Health, Germination, Viability/Vigour tests, Genetic Purity and Trait Purity as per ISTA standards.

Quality Assurance not only assures the quality of the seeds but also assures the quality during Processing, Treatment, Packing, Logistics and finally the dispatches to the market till it goes in the hands of the end user i.e., FARMER.

It also ensures the performance in the farmer’s fields by visiting randomly to Re-reassurance and farmer’s satisfaction.</p>
				</div>
			</div>
