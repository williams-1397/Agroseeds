          ...
          <div class="col-lg-6 ">
            <div class="login-form border p-5 ">
              <div class="text-center heading ">
                ...
                <p class="lead ">Don’t have an account? <a href="signup.php ">Create a free account</a></p>
              </div>
              ...
              <form method="POST" action="process.php">
                ...
                <input type="submit" class="btn btn-main mt-3 btn-block" name="login" value="login">
              </form>
              <div class="text-center heading ">

                <p class="lead "><a class="float-right " href="forgot-password.php">Forget password?</a></p>
                </div>
...
<!-- Mirrored from demo.themefisher.com/adrian/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Feb 2020 18:33:57 GMT -->
</html>
<?php
}
			else
