...
<!-- Mirrored from demo.themefisher.com/adrian/cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Feb 2020 18:33:55 GMT -->
                  ...
                  <table class="table shop_table shop_table_responsive cart " cellspacing="0 ">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>₹<?php error_reporting(E_ERROR | E_PARSE);echo number_format($values["item_quantity"] * $values["item_price"], 2);?></td>
                        <td><a class="btn btn-danger" href="cart.php?action=delete&id=<?php echo $values["item_id"]; ?>">Remove</a></td>
                      </tr>
                      <?php
                              $total = $total + ($values["item_quantity"] * $values["item_price"]);
                            }
                          ...
                          echo "<script>alert('YOUR CART IS EMPTY.PLEASE ADD SOME PRODUCT TO MAKE ORDER.')
            ...
            <div class="cart-info card p-4 mt-4 ">
                ...
                <ul class="list-unstyled mb-4 ">
                  <li class="d-flex justify-content-between pb-2 mb-3 ">
                    <h5>Subtotal</h5>
                    <span>₹<?php
                        error_reporting(E_ERROR | E_PARSE); echo number_format($total,2) ?></span>
                  </li>
                ...
                <a href="client_additional_details.php" class="btn btn-main btn-small ">Proceed to checkout</a>
            </div>
          </div>
        </div>
      </div>
